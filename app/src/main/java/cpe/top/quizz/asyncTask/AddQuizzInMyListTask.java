...
public class AddQuizzInMyListTask extends AsyncTask<String, Integer, ReturnObject> {
    public AsyncQuestionResponse delegate = null;

    public AddQuizzInMyListTask(AsyncQuestionResponse asyncResponse) {
        delegate = asyncResponse;
    }

    protected ReturnObject doInBackground(String... params) {
        // params[0] = pseudo, params[1] = id quizz
        ReturnObject u = QuizzUtils.addQuizzInMyList(params[0], params[1]);
